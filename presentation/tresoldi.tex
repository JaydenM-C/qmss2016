...
\item Ancestral State Recostruction -- do results from past methods match those of phylogenetic ones?
\begin{itemize}
	\item Data from MPI banks (PHOIBLE, ``Intercontinental Dictionary Series'', 
	  ``World Loanword Database''), paper dictionaries (and web scraping...)
